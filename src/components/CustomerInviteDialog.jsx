      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <UserPlus size={18} /> Invite Customer
          </DialogTitle>
        </DialogHeader>
        <div className="space-y-4 py-2">
          <div>
            <Label htmlFor="cust-name">Customer Name</Label>
            <Input id="cust-name" value={name} onChange={e => setName(e.target.value)} placeholder="John Smith" />
          </div>
          <div>
          ...
          <div>
            ...
            <Input id="cust-phone" value={phone} onChange={e => setPhone(e.target.value)} placeholder="(902) 555-1234" />
          </div>
          <div>
